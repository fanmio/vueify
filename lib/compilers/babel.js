...
var babelRcPath = path.resolve(process.cwd(), 'babel.config.js')
...
function getBabelRc () {
  var rc
  try {
    rc = require(babelRcPath)
  } catch (e) {
    throw new Error('[vueify] Your babel.config.js seems to be incorrectly formatted.')
  }
  return rc
}
